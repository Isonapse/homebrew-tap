...
# Placeholders: alpha-c25cbf432b5f45d7462e17c3680e3f9089d13834 0.3.0-beta alpha c25cbf4 c25cbf432b5f45d7462e17c3680e3f9089d13834
# ab7a375359a69bcfe3fd44fabd54b48c70326761af75cf3827611c7ca3cb4c33 f4614f338e055337c02f36c096ca53156bc4db53df418c6733df205ce92c73cf
...
# untrusted tap.
# Verified source commit: c25cbf432b5f45d7462e17c3680e3f9089d13834
class IsonapseAlpha < Formula
  ...
  version "0.3.0-beta+release.c25cbf4"
  revision 1000
  version_scheme 1000

  on_macos do
    on_arm do
      url "https://github.com/Isonapse/isonapse-releases/releases/download/alpha-c25cbf432b5f45d7462e17c3680e3f9089d13834/isonapse-candidate-c25cbf432b5f45d7462e17c3680e3f9089d13834-aarch64-apple-darwin.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
      sha256 "ab7a375359a69bcfe3fd44fabd54b48c70326761af75cf3827611c7ca3cb4c33"
    end
  ...
  on_linux do
    on_intel do
      url "https://github.com/Isonapse/isonapse-releases/releases/download/alpha-c25cbf432b5f45d7462e17c3680e3f9089d13834/isonapse-candidate-c25cbf432b5f45d7462e17c3680e3f9089d13834-x86_64-unknown-linux-gnu.tar.gz",
          using: GitHubPrivateReleaseDownloadStrategy
      sha256 "f4614f338e055337c02f36c096ca53156bc4db53df418c6733df205ce92c73cf"
    end
  end
  ...
  def install
    ...
    if OS.mac?
      identity_hex = "7b0a20202261726368697665223a202269736f6e617073652d63616e6469646174652d6332356362" \
                     "66343332623566343564373436326531376333363830653366393038396431333833342d61617263" \
                     "6836342d6170706c652d64617277696e2e7461722e677a222c0a202022617263686976655f736861" \
                     "323536223a2022616237613337353335396136396263666533666434346661626435346234386337" \
                     "30333236373631616637356366333832373631316337636133636234633333222c0a202022626173" \
                     ...
                     "6f6d6d6974223a202263323563626634333262356634356437343632653137633336383065336639" \
                     "303839643133383334222c0a202022746172676574223a2022616172636836342d6170706c652d64" \
                     "617277696e220a7d0a"
      signature_hex = "69736f6e617073652d72656c656173652d7369676e61747572652d76310a7373682d656432353531" \
                      ...
                      "7941414141557741414141747a633267745a5751790a4e5455784f5141414145434d744a4f394d70" \
                      "4270564775596235643369475533395a727a7a6e2f586f7939786b2b5a594b42585875687452444e" \
                      "5866446f7a5a5570467136322b4e784e68710a46327638432f37614c41435454747830417030420a" \
                      "2d2d2d2d2d454e4420535348205349474e41545552452d2d2d2d2d0a"
      identity_sha256 = "2a9123d4308699afc0b8fc5c8886323c2aa9d487178d25974fc2e06018d674c4"
    else
      identity_hex = "7b0a20202261726368697665223a202269736f6e617073652d63616e6469646174652d6332356362" \
                     "66343332623566343564373436326531376333363830653366393038396431333833342d7838365f" \
                     "36342d756e6b6e6f776e2d6c696e75782d676e752e7461722e677a222c0a20202261726368697665" \
                     "5f736861323536223a20226634363134663333386530353533333763303266333663303936636135" \
                     "3331353662633464623533646634313863363733336466323035636539326337336366222c0a2020" \
                     ...
                     "63655f636f6d6d6974223a2022633235636266343332623566343564373436326531376333363830" \
                     "65336639303839643133383334222c0a202022746172676574223a20227838365f36342d756e6b6e" \
      ...
      signature_hex = "69736f6e617073652d72656c656173652d7369676e61747572652d76310a7373682d656432353531" \
                      ...
                      "5a39736a425377504257337854667478577a4679394f37560a6d4b534b312b68365a626b41414141" \
                      "5161584e76626d467763325574636d56735a57467a5a5141414141414141414147633268684e5445" \
                      "7941414141557741414141747a633267745a5751790a4e5455784f5141414145447a705a6e50654b" \
                      "6579384a4c30494e7262734345797a375170752f36315a494842452b41304c68534648514c70586e" \
                      "4f552f566c4c5247503030525270622b70370a456f34313959345a44396b314843496a6458634a0a" \
                      "2d2d2d2d2d454e4420535348205349474e41545552452d2d2d2d2d0a"
      identity_sha256 = "21efa633c94c49970e3c72d8c630b10b3fcdddcca3756ffc06637d770efbf3f5"
    end
    ...
    (bin/"install-context.json").write "{\"build_identity_sha256\":\"#{identity_sha256}\"," \
                                       ...
                                       "\"format_version\":1," \
                                       "\"source_commit\":\"c25cbf432b5f45d7462e17c3680e3f9089d13834\"}\n"
  ...
  test do
    assert_match "0.3.0-beta+release.c25cbf4", shell_output("#{bin}/isonapse --version")
    assert_predicate bin/"isonapse-hook", :executable?
    assert_match "0.3.0-beta+release.c25cbf4", shell_output("#{bin}/isonapse-hook --version")
